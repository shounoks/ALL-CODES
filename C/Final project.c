...
void updateEmployeeSalary(Employee *emp, double increment) {
    emp->salary += increment;
    printf("Salary increased by %.2lf. Total salary for employee %s is now %.2lf.\n", increment, emp->name, emp->salary);
}
